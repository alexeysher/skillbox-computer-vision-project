...
#### 1.1.{#1.1} Извлечение изображений лиц из тренировочного датасета (`train_face_extraction`)
...
По аналогии с [предыдущим](#1.1) этапом в процессе выполнения этапа формируется архив изображений лиц и csv-файлы.
