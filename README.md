...
Для повышения удобства использования ноутбука при каждом его запуске происходит автоматическая установка необходимых библиотек необходимых для его работы на конкретной платформе.
